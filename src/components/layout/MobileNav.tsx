...
export const MobileNav: React.FC<MobileNavProps> = ({
  ...
  // Unauthenticated visitors do not see bottom navigation anywhere
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-surface-container-lowest border-t border-outline-variant px-6 py-2 pb-safe flex justify-around items-center shadow-2xl md:hidden">
      {isProvider ? (
        /* Business Owner Section: Dashboard, Bookings, Notifications */
        <>
          <button
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center w-20 py-1 transition-all active:scale-95 relative ${
          ...
          >
            <div
              className={`p-1 rounded-2xl relative ${
                currentRoute === 'notifications' ? 'bg-secondary-container text-on-secondary-container' : ''
              }`}
            >
        ...
        /* Consumer Section: Home, Bookings, Notifications */
        <>
          <button
