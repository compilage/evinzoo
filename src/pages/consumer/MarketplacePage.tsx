        ...
        <div className="bg-surface-container-lowest p-2 border border-outline-variant flex items-center shadow-sm rounded-2xl mb-6 max-w-2xl focus-within:ring-2 focus-within:ring-primary/20 transition-all">
          ...
          {searchQuery && (
            <button
              ...
              className="text-secondary hover:text-primary mr-2 transition-colors cursor-pointer"
            >
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar pb-2">
          {categories.map((cat) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition-all active:scale-95 border cursor-pointer ${
        ...
        {isSearching ? (
          ...
          <div className="text-center py-16 bg-surface-container-lowest rounded-3xl border border-outline-variant p-8">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-surface-container rounded-xl text-xs font-bold text-primary hover:bg-surface-container-high transition-colors cursor-pointer"
            >
              Reset Filters
            </button>
          </div>
                  ...
                  <div className="flex justify-between items-center border-t border-outline-variant pt-3 mt-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="bg-primary text-on-primary rounded-xl px-4 py-2 text-xs font-bold hover:bg-primary-container active:scale-95 transition-all shadow-sm flex items-center gap-1 hover:shadow-md cursor-pointer"
                      >
